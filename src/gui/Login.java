...
public class Login extends javax.swing.JFrame {
    ...
    private void login(){
        ...
        try{
            ...
            ResultSet rs=db.DbConnect.st.executeQuery("select * from admin_login where id='"+i+"' and password='"+pw+"'");
            if(rs.next()){
                Home h=new Home();
    ...
    private void initComponents() {
        ...
        p.setFont(new java.awt.Font("Tw Cen MT", 1, 12)); // NOI18N
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {id, jLabel3, jLabel4, p});
